        ...
        <div class="form-container">
            ...
            <div class="form-inner">
                <form action="./handler/proses_login" class="login" method="POST">
                    ...
                    <div class="pass-link">
                        <a href="./pluggin/handler/forget_pw.php" class="footer-link">Lupa password?</a>
                    </div>
                    <div class="signup-link">
                        Don't Have Account? <a href="../public/pluggin/register">Create A New</a>
                    </div>
                </form>
                <form id="registerForm" action="./handler/proses_register.php" class="signup" method="POST">
                    <div class="field">
