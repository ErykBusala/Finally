...
<body>
    <div class="container">
        ...
        <p>Silakan cek email Anda untuk mereset password. Jika tidak menemukan email di kotak masuk, periksa folder spam.</p>

        <!-- Tombol ke Beranda -->
        <a href="../login" class="btn-home">Kembali ke Beranda</a>
    </div>
</body>
</html>
